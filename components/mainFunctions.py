...
def get_percentage_difference(num_a, num_b):
    ...
    if num_b > num_a:
        ...
        return int((abs(num_a - num_b) / num_b) * 100)
...
def start_command(image: str, original_folder: str, output_folder: str, dformat: str, max_width: int, quality: int):
    ...
    try:
        ...
        # this fixes a problem which skips files, when if condition fails to detect a folder and tries to recreate it due to multicore processing.
        _ = Err
        pass
